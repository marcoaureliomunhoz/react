...
export function Game({ data, setFirstTeamPoints, setSecondTeamPoints, onGuessConfirm }: Props) {
  ...
  const gameAlreadyHappened = new Date(data.date) < new Date();
    ...
    >
      ...
      <HStack mt={4} w="full" justifyContent="space-between" alignItems="center">
        <Team
          ...
          guessTeamPointsValue={data?.guess?.firstTeamPoints}
          gameAlreadyHappened={gameAlreadyHappened}
        />
        ...
        <Team
          ...
          guessTeamPointsValue={data?.guess?.secondTeamPoints}
          gameAlreadyHappened={gameAlreadyHappened}
        />
      </HStack>

      {
        !data.guess && !gameAlreadyHappened &&
